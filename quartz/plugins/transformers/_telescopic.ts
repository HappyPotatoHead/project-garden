...
//   const containers = document.querySelectorAll(".telescopic-container")

//   containers.forEach((container) => {
//     const details = container.querySelectorAll(".details")
//     const expandButton = container.querySelector(".expand")
//     const replayButton = container.querySelector(".replay")
...
// .telescopic-container #fulltext {
//   display: none;
// }

// .telescopic-container .details {
//   cursor: pointer;
// }

// .telescopic-container .details.close > .expanded {
//   display: none;
// }

// .telescopic-container .details.open > .summary {
//   display: none;
// }

// .telescopic-container .expand,
// .telescopic-container .replay {
//   cursor: pointer;
//   margin-left: 0.4rem;
//   display: inline-flex;
...
//   const defaultDepthMatch = firstNonEmptyLine?.match(
//     `^\\s*(${RegexEscapedBulletSeparators.join("|")})`,
//   )

//   const defaultDepth = defaultDepthMatch ? defaultDepthMatch[0].length - 1 : 0
//   // const defaultDepth =
//   // // @ts-ignore
